...
function F(n17, r21 = {}, e9, a28, s20) {
  ...
  if (r21) {
    let d14 = false, p13 = [];
    for (let [c21, T10] of Object.entries(r21))
...
function $() {
  ...
  return (...e9) => {
    if (!e9.every((a28) => a28 == null))
      return n17.current = e9, r21;
  };
}
function I(...n17) {
  return n17.every((r21) => r21 == null) ? void 0 : (r21) => {
    for (let e9 of n17)
      e9 != null && (typeof e9 == "function" ? e9(r21) : e9.current = r21);
  };
}
function P2(...n17) {
  var a28;
  ...
  for (let s20 of n17)
    for (let t14 in s20)
      t14.startsWith("on") && typeof s20[t14] == "function" ? ((a28 = e9[t14]) != null || (e9[t14] = []), e9[t14].push(s20[t14])) : r21[t14] = s20[t14];
...
function pe(u25, b14) {
  let f21 = (0, import_react51.useId)(), y10 = u4(), T10 = a3(), { id: h15 = y10 || `headlessui-checkbox-${f21}`, disabled: o20 = T10 || false, autoFocus: i16 = false, checked: C11, defaultChecked: k13, onChange: x10, name: d14, value: g6, form: E13, indeterminate: l19 = false, tabIndex: v11 = 0, ...P8 } = u25, r21 = l3(k13), [a28, t14] = b2(C11, x10, r21 != null ? r21 : false), D12 = N(), R7 = w3(), A5 = p(), [F7, p13] = (0, import_react58.useState)(false), c21 = o4(() => {
    ...
    if (r21 !== void 0)
      return t14 == null ? void 0 : t14(r21);
  }, [t14, r21]), W5 = K();
...
function f8(t14, e9) {
  do {
    ...
    if (r21.done && s20.done)
      return true;
    if (r21.done || s20.done || !Object.is(r21.value, s20.value))
      return false;
  } while (true);
}
function p3(t14) {
...
function I3(o20, s20) {
  ...
  return n(() => {
    if (o20)
      return r21.actions.push(t14), () => r21.actions.pop(t14);
...
function m6(t14) {
  ...
  if (r21 === 1 ? u12.delete(t14) : u12.set(t14, r21 - 1), r21 !== 1)
    return;
  let e9 = f9.get(t14);
...
function k5(o20, f21, h15) {
  let m10 = s3(h15), s20 = (0, import_react68.useCallback)(function(e9, c21) {
    ...
    for (let u25 of M12)
      if (u25 !== null && (u25.contains(r21) || e9.composed && e9.composedPath().includes(u25)))
        return;
...
function e5(t14, u25) {
  return (0, import_react73.useMemo)(() => {
    ...
    if (typeof r21 == "string" && r21.toLowerCase() === "button" || (u25 == null ? void 0 : u25.tagName) === "BUTTON" && !u25.hasAttribute("type"))
      return "button";
  }, [t14.type, t14.as, u25]);
}
    ...
    r21.microTask(() => {
      ...
      r21.addEventListener(o20, "click", (t14) => {
        ...
        r21.addEventListener(o20, "touchstart", (e9) => {
          if (t14.dispose(), i4(e9.target) && r6(e9.target))
            if (a28(e9.target)) {
              let n17 = e9.target;
...
var j8 = { [1](t14) {
  ...
  var r21, u25, a28, s20;
  if ((r21 = t14.dataRef.current) != null && r21.disabled || t14.optionsElement && !((u25 = t14.dataRef.current) != null && u25.optionsPropsRef.current.static) && t14.comboboxState === 1)
    return t14;
  if (t14.virtual) {
  ...
  var r21, u25, a28, s20;
  if ((r21 = t14.dataRef.current) != null && r21.virtual)
...
var y6 = class _y extends T3 {
  constructor(e9) {
    ...
    f15(this, "selectors", { activeDescendantId: (e10) => {
      ...
      if (n17 !== null)
        return e10.virtual ? (r21 = e10.options.find((u25) => !u25.dataRef.current.disabled && e10.dataRef.current.compare(u25.dataRef.current.value, e10.virtual.options[n17]))) == null ? void 0 : r21.id : (o20 = e10.options[n17]) == null ? void 0 : o20.id;
  ...
  let c21 = o4(() => {
    ...
    if (n17 != null && n17.current)
      for (let e9 of n17.current)
        t14.push(e9);
    for (let e9 of (r21 = i16 == null ? void 0 : i16.querySelectorAll("html > *, body > *")) != null ? r21 : [])
...
function j9({ children: l19, node: n17 }) {
  ...
  return import_react93.default.createElement(d9.Provider, { value: i16 }, l19, i16 === null && import_react93.default.createElement(f4, { features: s5.Hidden, ref: (t14) => {
    var r21, u25;
    if (t14) {
      for (let e9 of (u25 = (r21 = l(t14)) == null ? void 0 : r21.querySelectorAll("html > *, body > *")) != null ? u25 : [])
...
function Fe2(e9, t14) {
  ...
  let G6 = l15();
  n(() => {
    if (f21 && G6 && m10 === "visible" && r21.current === null)
...
function Ae4(e9, t14) {
  let l19 = (0, import_react51.useId)(), { id: p13 = `headlessui-disclosure-button-${l19}`, disabled: a28 = false, autoFocus: c21 = false, ...n17 } = e9, [o20, r21] = M8("Disclosure.Button"), f21 = ye2(), s20 = f21 === null ? false : f21 === o20.panelId, E13 = (0, import_react100.useRef)(null), T10 = y(E13, t14, o4((i16) => {
    if (!s20)
      return r21({ type: 4, element: i16 });
  }));
  (0, import_react100.useEffect)(() => {
    if (!s20)
      return r21({ type: 2, buttonId: p13 }), () => {
    ...
    if (d14 !== null) {
      ...
      if (r21 !== null) {
        ...
        if (((l19 = O5.current) == null ? void 0 : l19.previousElementSibling) === u25.current || ((c21 = u25.current) == null ? void 0 : c21.previousElementSibling) === null)
          return { ...t14, activeOptionIndex: r21 };
      }
    }
...
function Et(b14, E13) {
  ...
  L4(S10, { trigger: t14, action: (0, import_react107.useCallback)((r21) => {
    if (t14 != null && t14.contains(r21.target))
      return S5.Ignore;
...
var k10 = { [1](e9) {
  ...
  for (let [s20, l19] of t14.entries())
    if (r21.has(l19.id) && (n17.push(s20), r21.delete(l19.id), r21.size === 0))
      break;
  if (n17.length > 0) {
    t14 = t14.slice();
    for (let s20 of n17.reverse())
...
function Le4(n17, t14) {
  ...
  let a28 = (0, import_react51.useId)(), f21 = u4(), h15 = a3(), { id: b14 = f21 || `headlessui-switch-${a28}`, disabled: o20 = h15 || false, checked: s20, defaultChecked: T10, onChange: y10, name: p13, value: c21, form: u25, autoFocus: S10 = false, ...C11 } = n17, _10 = (0, import_react113.useContext)(E12), [L7, R7] = (0, import_react113.useState)(null), G6 = (0, import_react113.useRef)(null), A5 = y(G6, t14, _10 === null ? null : _10.setSwitch, R7), l19 = l3(T10), [d14, r21] = b2(s20, y10, l19 != null ? l19 : false), F7 = p(), [H9, P8] = (0, import_react113.useState)(false), D12 = o4(() => {
    ...
    if (l19 !== void 0)
      return r21 == null ? void 0 : r21(l19);
  }, [r21, l19]), q5 = K();
